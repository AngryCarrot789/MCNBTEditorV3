...
namespace MCNBTEditor.WPF.Resources {
    ...
    public class IconTypeToImageSourceConverter : IValueConverter {
        ...
        public static Dictionary<string, Uri> UriMap { get; } = new Dictionary<string, Uri>();
        ...
        public static Uri IconTypeToUri(string type) {
            return type != null && UriMap.TryGetValue(type, out Uri uri) ? uri : null;
        }

        public static ImageSource IconTypeToImageSource(string type) {
